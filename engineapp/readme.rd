...
5:  Add Other Features on Your Own
 ...
 How to Run this project ?
    Go to folder: /engineapp/
    Template folder: comsist of all .html files required by main.py
    main.py: This is main python file that renders html files, and other
             operations such as Login,Logout etc.
    This project requires google app engine installed on your machine.
     For details click:
